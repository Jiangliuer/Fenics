...
\begin{frame}[shrink=5]{Results}
  ...
  L-shape
   \begin{center}
     \includegraphics[width=0.4\textwidth]{Image/u1_32.png}
     \includegraphics[width=0.4\textwidth]{Image/u1_e_32.png}
   \end{center}
   \begin{center}
     \includegraphics[width=0.4\textwidth]{Image/u1_64.png}
     \includegraphics[width=0.4\textwidth]{Image/u1_e_64.png}
   \end{center}
  \end{block}
\end{frame}
